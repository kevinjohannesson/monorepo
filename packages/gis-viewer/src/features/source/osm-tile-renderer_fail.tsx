...
export function OsmTileRenderer(): ReactElement | null {
  ...
  useEffect(() => {
    ...
    tileImageCache.availableZoomLevels.forEach((zoomLevelFromCache) => {
      if (
      ...
      gridTileIndices.forEach((gridTileIndex) => {
        ...
        const osmWholeTileNumbersForGridTileIndex = calculateOsmWholeTileNumbersForGridTileIndex(
          osmWholeCenterTileNumbersAtZoomLevel,
          gridTileIndex,
        );
        ...
        const isZoomLevelFromCacheHigherThanCurrent = zoomLevelFromCache > osmWholeScaledZoomLevel;
        ...
        ctx.drawImage(imageFromCache, dx, dy, dw, dh);
        ...
        //   const dx = 0;
        //   const dy = 0;
        //   const dw = pixelOffsetToCenterGridX + Math.min(...gridTileIndicesX) * gridTileWidth;
        //   const dh = gridHeight;
        ...
        //   const dy = 0;
        //   const dw = gridWidth;
        //   const dh = pixelOffsetToCenterGridY;
    ...
    pixelOffsetToCenterGridY,
    osmFractionalScaledZoomLevel,
    osmWholeCenterTileNumbersX,
    osmWholeCenterTileNumbersY,
    JSON.stringify(availableZoomLevelsInCacheForGridTileIndices),
    totalValidTileNumbersAtCurrentZoomLevel,
    totalFetchedTileImagesForCurrentZoomLevel,
    allPossibleTileImagesForCurrentZoomLevelAreCached,
    tileImageCache.availableZoomLevels.join(),
  ]);
